...
document.querySelector("main h2").textContent = "Nuevo titulo desde JS";
document.querySelector("#contenidoPrincipal").textContent += "- Modificado desde JS";

document.querySelector("main").innerHTML += '<p class="parrafo">Parrafo5</p>';
let h2 = document.querySelector("h2");
console.log(h2);
h2.textContent = "Nuevo titulo desde JS";
...
document.querySelector("#destino").innerHTML += "<p>Texto agregado desde JS";
